  ...
  return (
    <Card sx={{ px: 3, py: 1, mt: 5 }}>
      <CardHeader
        ...
        sx={{ mb: 3, pl: 0 }}
        action={
          <Button variant="text" onClick={() => router.push('/dashboard/clients/ClientList')}>Full Report</Button>
        }
      />
